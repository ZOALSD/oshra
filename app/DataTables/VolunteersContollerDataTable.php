...
class VolunteersContollerDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.volunteerscontoller.buttons.actions')

            ->addColumn('sex', '{{ trans("admin.".$sex) }}')

            ->addColumn('Volunteer_qu', '{{ trans("admin.".$Volunteer_qu) }}')

            ->addColumn('cv_file', 'admin.volunteerscontoller.buttons.cv_file')
            ...
            ->rawColumns(['checkbox','actions','cv_file',]);
    }
    ...
    {
        return Volunteers::query()->select("volunteers.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 ...
                 'searchable' => false,
                 'orderable'  => false,
                 'title'=>trans('admin.Volunteer_qu'),
		    ],
			/*	[
                 'name'=>'name_collaction',
                 'data'=>'name_collaction',
                 'title'=>trans('admin.name_collaction'),
		    ],
				/*[
                 'name'=>'join_us_qu',
                 'data'=>'join_us_qu',
                 'title'=>trans('admin.join_us_qu'),
		    ],*/
				[
                 'name'=>'cv_file',
                 'data'=>'cv_file',
                 'title'=>trans('admin.cv_file'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
	    ...
	    {
	        return 'volunteerscontoller_' . time();
	    }
