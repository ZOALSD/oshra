...
class MemberDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.member.buttons.actions')

            ->addColumn('member_image', 'admin.member.buttons.member_image')
            ...
            ->rawColumns(['checkbox','actions','member_image',]);
    }
    ...
    {
        return Member::query()->select("members.*");
	    ...
	    protected function getColumns()
	    {
           ...
           [
               ...
               'title'=>trans('admin.id'),
				...
				[
                 'name'=>'member_name_'.app('l'),
                 'data'=>'member_name_'.app('l'),
                 'title'=>trans('admin.member_name_'.app('l')),
		    ],

				[
                 'name'=>'member_about_'.app('l'),
                 'data'=>'member_about_'.app('l'),
                 'title'=>trans('admin.member_about_'.app('l')),
		    ],
				[
                 'name'=>'member_image',
                 'data'=>'member_image',
                 'title'=>trans('admin.member_image'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
