...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.blog.buttons.actions')

            ->addColumn('blog_img', 'admin.blog.buttons.blog_img')
    ...
    {
        return Blog::query()->select("blogs.*")->orderBy('id','desc');
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
                ...
                [
                    'name'=>'blog_title_'.app('l'),
                    'data'=>'blog_title_'.app('l'),
                    'title'=>trans('admin.blog_title_'.app('l')),
                ],
			...
			/*	[
                 'name'=>'blog_url_video',
                 'data'=>'blog_url_video',
                 'title'=>trans('admin.blog_url_video'),
		    ],*/
				[
                 'name'=>'blog_write_ar',
                 'data'=>'blog_write_ar',
                 'title'=>trans('admin.blog_write_ar'),
		    ],
			/*	[
                 'name'=>'blog_write_en',
                 'data'=>'blog_write_en',
                 'title'=>trans('admin.blog_write_en'),
		    ],
				[
                 'name'=>'blog_key',
                 'data'=>'blog_key',
                 'title'=>trans('admin.blog_key'),
		    ],*/
            [
	                'name' => 'actions',
	                'data' => 'actions',
