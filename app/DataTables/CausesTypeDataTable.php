...
class CausesTypeDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.causestype.buttons.actions')
    ...
    {
        return Causestype::query()->select("causestypes.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'causes_catgorase_ar',
                 'data'=>'causes_catgorase_ar',
                 'title'=>trans('admin.causes_catgorase_ar'),
		    ],
				[
                 'name'=>'causes_catgorase_en',
                 'data'=>'causes_catgorase_en',
                 'title'=>trans('admin.causes_catgorase_en'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
