...
{!! Form::open(['url'=>aurl('/manger'),'id'=>'manger','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('password_check',old('password'),['class'=>'form-control','placeholder'=>trans('admin.password')]) !!}
    </div>
</div>
<br>
