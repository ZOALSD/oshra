...
{!! Form::open(['url'=>aurl('/message'),'id'=>'message','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
		...
		<div class="col-md-9">
{!! Form::select('see',['new'=>trans('admin.new'),'old'=>trans('admin.old'),],old('see'),['class'=>'form-control','placeholder'=>trans('admin.see')]) !!}
		</div>
</div>
<br>
