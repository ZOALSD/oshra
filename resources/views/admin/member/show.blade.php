              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('member/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.member')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$member->id}} ؟
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($member->admin_id)->name }}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_name_ar')}} :</b>
 {!! $member->member_name_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_name_en')}} :</b>
 {!! $member->member_name_en !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_about_ar')}} :</b>
 {!! $member->member_about_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_about_en')}} :</b>
 {!! $member->member_about_en !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_face')}} :</b>
 {!! $member->member_face !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_twitter')}} :</b>
 {!! $member->member_twitter !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_instgram')}} :</b>
 {!! $member->member_instgram !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.member_image')}} :</b>
 {!! $member->member_image !!}
</div>
