              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('causestype/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.causestype')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$causestype->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$causestype->id}}
</div>
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($causestype->admin_id)->name }}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.causes_catgorase_ar')}} :</b>
 {!! $causestype->causes_catgorase_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.causes_catgorase_en')}} :</b>
 {!! $causestype->causes_catgorase_en !!}
</div>
